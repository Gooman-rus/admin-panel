<? 
   ...
   $thisnewsquery="select object_name$lng,object_text$lng 
                  from {$PREFFIX}_price
   ...
   list($thisservice_name,$thisservice_text)=mysql_fetch_array($thisnewslres);
  
   $page_metakeys="";
   $page_metadesc=$thisservice_name;
