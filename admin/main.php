...
if((isAllowed("rlisten")) || (isAllowed("rdirectory")) || (isAllowed("rread")) )
{
echo"
<table class=grayhead Border=0 CellSpacing=0 CellPadding=0>
...
<table Border=0 CellSpacing=15 CellPadding=0>
 <tr class=middletext align=center valign=top>";
if (isAllowed("rlisten")) echo"
    <td><a href=\"servise.php\"><img src=\"graph/icon/mainplayer.gif\" border=0><p class=\"space\">услуги</a></td>
    <td>&nbsp;</td>";
if (isAllowed("rdirectory")) echo"
    <td><a href=\"price.php\"><img src=\"graph/icon/law.gif\" border=0><p class=\"space\">цены</a></td>
    <td>&nbsp;</td>";
if (isAllowed("rread")) echo"
    <td><a href=\"objects.php\"><img src=\"graph/icon/dep.gif\" border=0><p class=\"space\">портфолио</a></td>
    <td>&nbsp;</td>";
echo"
 </tr>
</table>
