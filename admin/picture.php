  ...
  if ($_FILES['picbig'])
{
 ...
 $query="insert into {$PREFFIX}_picture values($newunitcode,$page_code,'$small','$big',$picpos,'$piccomment','$piccomment_en')";
 echo"$query";
...
<?php
   $q="select * from {$PREFFIX}_page order by page_name";
...
<table Border=0 CellSpacing=0 class=pagebluetable CellPadding=0>
 ...
 <tr height=30 >
    <td class=lmenutext>Коментарий (англ):</td>
    <td width=5></td>
