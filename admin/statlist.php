...
<table Border=0 CellSpacing=1 class=bluetable CellPadding=4 width=100%>
  <tr class=lmenutext align=center  height=20 bgcolor=#ffffff>
    ...
    <td width=130 align=center >Содержимое страницы</td>
...
<?php
	...
	if($num_rows)
	{
		...
		for ($x=$start_pos; $x<$end_pos; $x++)
		{
			...
			echo"<td align=center ><a href='editstatic.php?page_code=$page_code&page_name=$page_name'><img height='20' width='20' src='graph/edit.gif' border=0 title='Редактировать содержимое страницы'></a></td>";
