...
<body>
  ...
  if($num_rows)
  {
      ...
      while(list($picsmall,$picbig,$piccomment)=mysql_fetch_array($picres))
      {
        ...
        {
          echo"
            <div class=big_img><img src='images/$picbig' alt='$piccomment' /></div>
            <div class=controll>
            ...
            <div class=preview>
                <ul>
                    <li class=current><a href='#'><img src='images/$picbig' title='$piccomment' /></a></li>
        ...
        {
           echo"
              <li><a href='#'><img src='images/$picbig' title='$piccomment' /></a></li>
           "; 
        }
